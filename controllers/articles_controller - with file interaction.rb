...
module Example
  class Main
    ...
    def create_connection_script
      #command_path = '/tmp/connect-to-example-ftp-server.sh'  #error 
	  command_path = 'localhost:14147'   #ftp server address goes here 
...
@var2 = Main.new(ARGV)
#@var3 = @var2.create_connection_script
